...
import day43_OOPAbstractionIntro.employeeTask.*;
...
public class PolymorphismIntro {
    ...
    public static void main(String[] args) {
        ...
        boolean isSquare = shape instanceof Square; //verify if is square
        boolean isRectangle = shape instanceof Rectangle;  //verify if is Rectangle
        boolean isTriangle = shape instanceof Triangle; //verify if is Triangle
        boolean isCircle = shape instanceof Circle;  //verify if is circle
