...
public class MapPractice {
    ...
    public static void main(String[] args) {
        ...
        //ListOfMapsAllowsMeToStore6Maps // AddAllMapsByUsing addAll() ToTheList
        //ThenICanIterateByUsing forEachLoop For( : allUnits ){.ThenIGive llUnits On The Right & Left I Give
        // Tittle Represent The Elements of the List-->for (Map<String, Double> eachUnit : allUnits) {
        //NextIterateThe map by the pairs UseEntrySet()-->for(Map.Entry<String, Double> entry:eachUnit.entrySet()){
        //Call for EachLoopToGetUEntry
        //PrintFromThePairICanRetrieveTheKeyCallGetKey()-->System.out.println(entry.getKey()+":"+entry.getValue());
        //TheCall get value()
        ...
        System.out.println("---------------------------------------------------------");
        //U Can StillGetNested For Loop Below To Activate EachEntry,
        //NextCallGetValue()ToGetEachValueFromTheEntryIfTheValueIs >=7ThenDisplayTopicName->if(entry.getValue() >=7){
        //PrintToDisplay the name of the topic from the entry get the keys--->System.out.println(entry.getKey());
        ...
        System.out.println("---------------------------------------------------------");
        //Apply the Same nested Loop For the loop below Only change the condition less the 3--->< 3){
        ...
        System.out.println("---------------------------------------------------------");
        //DoTask4&5Together Order toFind MaxHour FirstAssignThe Min Hours-->double max=Double.MIN_VALUE;
        //ThenTheNameOfTheTopicAssignToTheVariable-->String name1 = "";
        //ToFindMaxHoursAssignIfConditionCallGetValue().IfHouris>TheAssign2VariableMax-->if(entry.getValue() > max){
        //-->max = entry.getValue();    /-->name1 = entry.getKey();
        //ToFindMinHoursApproachAssign minValue
