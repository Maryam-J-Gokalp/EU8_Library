...
public class ArrayOfMap {
    ...
    public static void main(String[] args) {
       ...
       //Declare if array type set [] & set array size-->Map[5];. Once have array u canNotIncreaseOrDecrease
       //You Can Store mapListInto array assignByEachIndex-->array[0] =scrumTeam1;. Do the SameToTheRemaining Index
